...
const options = [
    { key: 1, text: 'Historical Fiction', value:'Historical Fiction' },
    { key: 2, text: 'Biography', value: 'Biography' },
    { key: 3, text: 'Fiction', value: 'Fiction' },
    { key: 4, text: 'Non-fiction', value: 'Non-fiction' },
    { key: 5, text: 'Autobiography', value: 'Autobiography' },
    { key: 6, text: 'Text Book', value: 'TextBook' },
  ]
    ...
    return (
        <div>
            ...
            <form className='addbook-form' onSubmit={addBook}>
                ...
                <label className="addbook-form-label" htmlFor="categories">Categories</label><br />
